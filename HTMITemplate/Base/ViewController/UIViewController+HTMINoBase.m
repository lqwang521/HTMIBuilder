...
@implementation UIViewController (HTMINoBase)
...
- (void)setViewModel:(id<HTMIViewControllerProtocol>)viewModel
{
    objc_setAssociatedObject(self, kViewModelKey, viewModel, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (id<HTMIViewControllerProtocol>)viewModel
{
